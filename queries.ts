...
export const currentWeather = (bucket:any) => flux`from(bucket: "${bucket}")
    ...
    |> filter(fn: (r) => r["_field"] == "mountAz" or r["_field"] == "mountEl" or r["_field"] == "relativeHumidityItem" or r["_field"] == "dewPointItem" or r["_field"] == "temperatureItem0" or r["_field"] == "speed" or r["_field"] == "pressureItem0" or r["_field"] == "direction")
    |> last()
  ...
  export const hourlyWeather = (bucket:any) => {
    ...
    data = from(bucket: "${bucket}")
        ...
        |> filter(fn: (r) => r["_field"] == "relativeHumidityItem" or r["_field"] == "dewPointItem" or r["_field"] == "temperatureItem0" or r["_field"] == "speed" or r["_field"] == "pressureItem0" or r["_field"] == "direction")
        |> drop(columns: ["_measurement"])
